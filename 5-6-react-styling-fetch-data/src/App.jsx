    ...
    <div className="app">
      ...
      <header className="bg-primary text-white py-3 mb-4 shadow">
        <Container className="text-center">
          <h1 className="display-4 m-0">User Management Dashboard</h1>
          <p className="lead m-0">Search users and view details</p>
        </Container>
      </header>
      ...
      <footer className="bg-light py-4 mt-5">
        <Container className="text-center text-muted">SWE 363 — React Lab</Container>
      </footer>
    </div>
  );
}
